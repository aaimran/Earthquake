...
def update_graphs(time_value, sim_data, tau_val):
    ...
    # Use precomputed global velocity bounds.
    v_min, v_max = sim_data["v_bounds"]
    
    # Adjust stress bounds by the initial stress.
    s_min = sim_data["s_bounds"][0] + initial_stress
    s_max = sim_data["s_bounds"][1] + initial_stress
